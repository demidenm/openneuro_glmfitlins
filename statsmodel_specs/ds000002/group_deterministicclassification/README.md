...
The size of the Fitlins Derivatives for ds000002 deterministicclassification is 2.6M with 518 files.
...
## 4.1 Design Matrix
![Design Matrix](./files/ds000002_task-deterministicclassification_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000002_task-deterministicclassification_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000002_task-deterministicclassification_vif-boxplot.png)
...
![R Square](./files/ds000002_task-deterministicclassification_rsquare-mean.png)
...
![Dice](./files/ds000002_task-deterministicclassification_hist-dicesimilarity.png)
![Voxels Out](./files/ds000002_task-deterministicclassification_hist-voxoutmask.png)

## 5 Statistical Maps

### feedback
![feedback Map](./files/ds000002_task-deterministicclassification_contrast-feedback_map.png)
