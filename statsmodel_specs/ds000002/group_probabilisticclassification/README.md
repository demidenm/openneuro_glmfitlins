...
The size of the Fitlins Derivatives for ds000002 probabilisticclassification is 2.6M with 518 files.

Dataset- and task-relevant citations may be found in the papers: [Paper 1](https://doi.org/10.1016/j.neuroimage.2005.08.010).
...
trial_type.feedback, trial_type.feedback_derivative
...
## 4.1 Design Matrix
![Design Matrix](./files/ds000002_task-probabilisticclassification_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000002_task-probabilisticclassification_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000002_task-probabilisticclassification_vif-boxplot.png)
...
![R Square](./files/ds000002_task-probabilisticclassification_rsquare-mean.png)
...
sub-01_run-1, sub-01_run-2

The distribution for subjects and runs in probabilisticclassification are below. 

![Dice](./files/ds000002_task-probabilisticclassification_hist-dicesimilarity.png)
![Voxels Out](./files/ds000002_task-probabilisticclassification_hist-voxoutmask.png)

## 5 Statistical Maps

### feedback
![feedback Map](./files/ds000002_task-probabilisticclassification_contrast-feedback_map.png)
