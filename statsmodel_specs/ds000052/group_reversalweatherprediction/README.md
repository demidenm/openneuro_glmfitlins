# ds000052: reversalweatherprediction Task Analysis Report

The size of the Fitlins Derivatives for ds000052 reversalweatherprediction is 4.0M with 878 files.
...
## 4.1 Design Matrix
![Design Matrix](./files/ds000052_task-reversalweatherprediction_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000052_task-reversalweatherprediction_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000052_task-reversalweatherprediction_vif-boxplot.png)
...
![R Square](files/ds000052_task-reversalweatherprediction_rsquare-mean.png)
...
![Dice](files/ds000052_task-reversalweatherprediction_hist-dicesimilarity.png)
![Voxels Out](files/ds000052_task-reversalweatherprediction_hist-voxoutmask.png)

## 5 Statistical Maps

### neg
![neg Map](files/ds000052_task-reversalweatherprediction_contrast-neg_map.png)

### pos
![pos Map](files/ds000052_task-reversalweatherprediction_contrast-pos_map.png)

### negvpos
![negvpos Map](files/ds000052_task-reversalweatherprediction_contrast-negvpos_map.png)
