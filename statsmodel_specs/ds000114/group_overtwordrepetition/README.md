# ds000114: overtwordrepetition Task Analysis Report

The size of the Fitlins Derivatives for ds000114 overtwordrepetition is 1.4M with 254 files.
...
## 4.1 Design Matrix
![Design Matrix](./files/ds000114_task-overtwordrepetition_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000114_task-overtwordrepetition_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000114_task-overtwordrepetition_vif-boxplot.png)
...
![R Square](./files/ds000114_task-overtwordrepetition_rsquare-mean.png)
...
The subjects flagged for overtwordrepetition are:
sub-01_ses-retest, sub-02_ses-retest, sub-02_ses-test, sub-03_ses-retest, sub-03_ses-test, sub-04_ses-retest, sub-04_ses-test, sub-05_ses-retest, sub-05_ses-test, sub-06_ses-test, sub-07_ses-retest, sub-07_ses-test, sub-08_ses-retest, sub-08_ses-test, sub-09_ses-retest, sub-09_ses-test, sub-10_ses-test

The distribution for subjects and runs in overtwordrepetition are below. 

![Dice](./files/ds000114_task-overtwordrepetition_hist-dicesimilarity.png)
![Voxels Out](./files/ds000114_task-overtwordrepetition_hist-voxoutmask.png)
...
#### ses-test
![task ses-test Map](./files/ds000114_task-overtwordrepetition_ses-test_contrast-task_map.png)

#### ses-retest
![task ses-retest Map](./files/ds000114_task-overtwordrepetition_ses-retest_contrast-task_map.png)
