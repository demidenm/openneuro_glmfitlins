# ds000115: letter0backtask Task Analysis Report

The size of the Fitlins Derivatives for ds000115 letter0backtask is 1.3G with 1100 files.

Dataset- and task-relevant citations may be found in the papers: [Paper 1](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3358772/).
...
trial_type.nbacknontarget, intercept

### 2.3 Convolved Regressors
trial_type.nbacknontarget
...
- **zeroback**: 1*`trial_type.nbacknontarget`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds000115_task-letter0backtask_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000115_task-letter0backtask_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000115_task-letter0backtask_vif-boxplot.png)
...
![R Square](files/ds000115_task-letter0backtask_rsquare-mean.png)
...
The subjects flagged for letter0backtask are:
None Subjects Flagged

The distribution for subjects and runs in letter0backtask are below. 

![Dice](files/ds000115_task-letter0backtask_hist-dicesimilarity.png)
![Voxels Out](files/ds000115_task-letter0backtask_hist-voxoutmask.png)

## 5 Statistical Maps

### zeroback
![zeroback Map](files/ds000115_task-letter0backtask_contrast-zeroback_map.png)
