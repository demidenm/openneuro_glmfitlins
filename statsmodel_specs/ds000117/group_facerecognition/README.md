...
- **unfamiliarinitialvrepeats**: 1.0*`trial_type.unfamiliar_initial` - 0.5*`trial_type.unfamiliar_immediate` - 0.5*`trial_type.unfamiliar_delayed`
- **rt**: 1*`rt_reg.rt`
