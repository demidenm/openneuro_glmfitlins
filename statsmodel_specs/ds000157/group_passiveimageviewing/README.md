# ds000157: passiveimageviewing Task Analysis Report

The size of the Fitlins Derivatives for ds000157 passiveimageviewing is 1.3G with 926 files.

Dataset- and task-relevant citations may be found in the papers: [Paper 1](https://doi.org/10.1016/j.bbr.2013.03.041).
...
trial_type.break, trial_type.food, trial_type.nonfood, intercept

### 2.3 Convolved Regressors
trial_type.break, trial_type.food, trial_type.nonfood
...
- **foodvnonfood**: 1*`trial_type.food` - 1*`trial_type.nonfood`

- **foodvbaseline**: 1*`trial_type.food`

- **nonfoodvbaseline**: 1*`trial_type.nonfood`

- **all**: 0.5*`trial_type.food` + 0.5*`trial_type.nonfood`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds000157_task-passiveimageviewing_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds000157_task-passiveimageviewing_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds000157_task-passiveimageviewing_vif-boxplot.png)
...
![R Square](files/ds000157_task-passiveimageviewing_rsquare-mean.png)
...
The subjects flagged for passiveimageviewing are:
sub-12, sub-14, sub-15, sub-19, sub-25, sub-28

The distribution for subjects and runs in passiveimageviewing are below. 

![Dice](files/ds000157_task-passiveimageviewing_hist-dicesimilarity.png)
![Voxels Out](files/ds000157_task-passiveimageviewing_hist-voxoutmask.png)

## 5 Statistical Maps

### foodvnonfood
![foodvnonfood Map](files/ds000157_task-passiveimageviewing_contrast-foodvnonfood_map.png)

### foodvbaseline
![foodvbaseline Map](files/ds000157_task-passiveimageviewing_contrast-foodvbaseline_map.png)

### nonfoodvbaseline
![nonfoodvbaseline Map](files/ds000157_task-passiveimageviewing_contrast-nonfoodvbaseline_map.png)

### all
![all Map](files/ds000157_task-passiveimageviewing_contrast-all_map.png)
