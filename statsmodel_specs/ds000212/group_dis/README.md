# ds000212: dis Task Analysis Report
...
- **purityintentionalvneutral**: 0.5*`trial_type.h_ii` + 0.5*`trial_type.i_pi` - 0.5*`trial_type.e_na` - 0.5*`trial_type.j_ni`
