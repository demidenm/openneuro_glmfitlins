# ds000212: fb Task Analysis Report

The size of the Fitlins Derivatives for ds000212 fb is 5.5G with 4202 files.
...
trial_type.belief, trial_type.photo, rt_reg.rt, intercept

### 2.3 Convolved Regressors
trial_type.belief, trial_type.photo, rt_reg.rt
...
- **beliefvphoto**: 1*`trial_type.belief` - 1*`trial_type.photo`

- **photo**: 1*`trial_type.photo`

- **belief**: 1*`trial_type.belief`
...
![R Square](files/ds000212_task-fb_rsquare-mean.png)
...
The subjects flagged for fb are:
sub-13_run-03, sub-13_run-04, sub-18_run-02, sub-18_run-03, sub-18_run-04, sub-19_run-01, sub-19_run-02, sub-19_run-03, sub-19_run-04, sub-30_run-01, sub-30_run-02, sub-35_run-01, sub-35_run-02, sub-35_run-03, sub-35_run-04

The distribution for subjects and runs in fb are below. 

![Dice](files/ds000212_task-fb_hist-dicesimilarity.png)
![Voxels Out](files/ds000212_task-fb_hist-voxoutmask.png)

## 5 Statistical Maps

### beliefvphoto
![beliefvphoto Map](files/ds000212_task-fb_contrast-beliefvphoto_map.png)

### photo
![photo Map](files/ds000212_task-fb_contrast-photo_map.png)

### belief
![belief Map](files/ds000212_task-fb_contrast-belief_map.png)

### rt
![rt Map](files/ds000212_task-fb_contrast-rt_map.png)
