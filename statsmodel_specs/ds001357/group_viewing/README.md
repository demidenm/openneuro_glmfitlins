# ds001357: viewing Task Analysis Report

The size of the Fitlins Derivatives for ds001357 viewing is 1.7G with 1208 files.
...
trial_type.familiarfaces, trial_type.fourier, trial_type.unfamiliarfaces, intercept

### 2.3 Convolved Regressors
trial_type.familiarfaces, trial_type.fourier, trial_type.unfamiliarfaces
...
- **familiarvunfamiliar**: 1*`trial_type.familiarfaces` - 1*`trial_type.unfamiliarfaces`

- **familiarvfourier**: 1*`trial_type.familiarfaces` - 1*`trial_type.fourier`

- **unfamiliarvfourier**: 1*`trial_type.unfamiliarfaces` - 1*`trial_type.fourier`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds001357_task-viewing_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds001357_task-viewing_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds001357_task-viewing_vif-boxplot.png)
...
![R Square](files/ds001357_task-viewing_rsquare-mean.png)
...
The subjects flagged for viewing are:
None Subjects Flagged

The distribution for subjects and runs in viewing are below. 

![Dice](files/ds001357_task-viewing_hist-dicesimilarity.png)
![Voxels Out](files/ds001357_task-viewing_hist-voxoutmask.png)

## 5 Statistical Maps

### familiarvunfamiliar
![familiarvunfamiliar Map](files/ds001357_task-viewing_contrast-familiarvunfamiliar_map.png)

### familiarvfourier
![familiarvfourier Map](files/ds001357_task-viewing_contrast-familiarvfourier_map.png)

### unfamiliarvfourier
![unfamiliarvfourier Map](files/ds001357_task-viewing_contrast-unfamiliarvfourier_map.png)
