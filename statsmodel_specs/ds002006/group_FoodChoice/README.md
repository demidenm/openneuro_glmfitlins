# ds002006: FoodChoice Task Analysis Report

The size of the Fitlins Derivatives for ds002006 FoodChoice is 3.9G with 2720 files.
...
trial_type.foodchoice, rt_reg.rt, DELTAVALUE, intercept

### 2.3 Convolved Regressors
trial_type.foodchoice, rt_reg.rt, DELTAVALUE
...
- **foodchoice**: 1*`trial_type.foodchoice`

- **valuedifference**: 1*`DELTAVALUE`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds002006_task-FoodChoice_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds002006_task-FoodChoice_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds002006_task-FoodChoice_vif-boxplot.png)
...
![R Square](files/ds002006_task-FoodChoice_rsquare-mean.png)
...
The subjects flagged for FoodChoice are:
None Subjects Flagged

The distribution for subjects and runs in FoodChoice are below. 

![Dice](files/ds002006_task-FoodChoice_hist-dicesimilarity.png)
![Voxels Out](files/ds002006_task-FoodChoice_hist-voxoutmask.png)

## 5 Statistical Maps

### rt
![rt Map](files/ds002006_task-FoodChoice_contrast-rt_map.png)

### foodchoice
![foodchoice Map](files/ds002006_task-FoodChoice_contrast-foodchoice_map.png)

### valuedifference
![valuedifference Map](files/ds002006_task-FoodChoice_contrast-valuedifference_map.png)
