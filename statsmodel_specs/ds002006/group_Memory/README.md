# ds002006: Memory Task Analysis Report

The size of the Fitlins Derivatives for ds002006 Memory is 5.9G with 4022 files.
...
For the 28 subjects, whole-brain, mass univariate analyses were performed using a general linear model (GLM). The 5 regressors of interest (out of 6 total regressors) were convolved with a spm hemodynamic response function (see Section 2.3 for list). Of the convolved regressors, 1 were parametrically modulated regressors in the model (see Section 2.4 for list). The design matrix (see example in Section 4.1) included both the convolved and parametrically modulated regressors of interest and 27 nuisance regressors to account for physiological noise and motion-related artifacts (see Section 2.4 for full list).
...
trial_type.correctrejection, trial_type.falsealarm, trial_type.hit, rt_reg.rt, liking_demean, intercept

### 2.3 Convolved Regressors
trial_type.correctrejection, trial_type.falsealarm, trial_type.hit, rt_reg.rt, liking_demean
...
- **hitvcorrectrejection**: 1*`trial_type.hit` - 1*`trial_type.correctrejection`

- **falsealarmvhit**: 1*`trial_type.falsealarm` - 1*`trial_type.hit`

- **paramliking**: 1*`liking_demean`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds002006_task-Memory_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds002006_task-Memory_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds002006_task-Memory_vif-boxplot.png)
...
![R Square](files/ds002006_task-Memory_rsquare-mean.png)
...
The subjects flagged for Memory are:
None Subjects Flagged

The distribution for subjects and runs in Memory are below. 

![Dice](files/ds002006_task-Memory_hist-dicesimilarity.png)
![Voxels Out](files/ds002006_task-Memory_hist-voxoutmask.png)

## 5 Statistical Maps

### rt
![rt Map](files/ds002006_task-Memory_contrast-rt_map.png)

### hitvcorrectrejection
![hitvcorrectrejection Map](files/ds002006_task-Memory_contrast-hitvcorrectrejection_map.png)

### falsealarmvhit
![falsealarmvhit Map](files/ds002006_task-Memory_contrast-falsealarmvhit_map.png)

### paramliking
![paramliking Map](files/ds002006_task-Memory_contrast-paramliking_map.png)
