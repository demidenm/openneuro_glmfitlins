# ds002294: roletrait Task Analysis Report

The size of the Fitlins Derivatives for ds002294 roletrait is 29G with 17846 files.
...
- **groupbias**: 1*`trial_type.selfGroupBlock` - 1*`trial_type.friendGroupBlock`
