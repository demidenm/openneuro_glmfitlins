# ds002338: 1dNF Task Analysis Report

The size of the Fitlins Derivatives for ds002338 1dNF is 254M with 386 files.
...
trial_type.Rest, trial_type.Task-NF, intercept

### 2.3 Convolved Regressors
trial_type.Rest, trial_type.Task-NF
...
- **taskvrest**: 1*`trial_type.Task-NF` - 1*`trial_type.Rest`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds002338_task-1dNF_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds002338_task-1dNF_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds002338_task-1dNF_vif-boxplot.png)
...
![R Square](files/ds002338_task-1dNF_rsquare-mean.png)
...
The subjects flagged for 1dNF are:
sub-xp201_run-1, sub-xp201_run-2, sub-xp201_run-3, sub-xp202_run-1, sub-xp202_run-2, sub-xp202_run-3, sub-xp203_run-1, sub-xp203_run-2, sub-xp203_run-3, sub-xp206_run-1, sub-xp206_run-2, sub-xp206_run-3, sub-xp211_run-1, sub-xp211_run-2, sub-xp211_run-3, sub-xp218_run-1, sub-xp218_run-2, sub-xp218_run-3, sub-xp219_run-1, sub-xp219_run-2, sub-xp220_run-1, sub-xp220_run-2, sub-xp220_run-3, sub-xp220_run-4, sub-xp222_run-1, sub-xp222_run-2, sub-xp222_run-3

The distribution for subjects and runs in 1dNF are below. 

![Dice](files/ds002338_task-1dNF_hist-dicesimilarity.png)
![Voxels Out](files/ds002338_task-1dNF_hist-voxoutmask.png)

## 5 Statistical Maps

### taskvrest
![taskvrest Map](files/ds002338_task-1dNF_contrast-taskvrest_map.png)
