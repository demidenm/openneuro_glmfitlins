# ds003441: 2Swallow Task Analysis Report

The size of the Fitlins Derivatives for ds003441 2Swallow is 189M with 122 files.
...
trial_type.Face, trial_type.Hand, trial_type.Swallow, intercept

### 2.3 Convolved Regressors
trial_type.Face, trial_type.Hand, trial_type.Swallow
...
- **handvswallow**: 1*`trial_type.Hand` - 1*`trial_type.Swallow`

- **facevswallow**: 1*`trial_type.Face` - 1*`trial_type.Swallow`

- **hand**: 1*`trial_type.Hand`

- **face**: 1*`trial_type.Face`

- **swallow**: 1*`trial_type.Swallow`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds003441_task-2Swallow_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds003441_task-2Swallow_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds003441_task-2Swallow_vif-boxplot.png)
...
![R Square](files/ds003441_task-2Swallow_rsquare-mean.png)
...
The subjects flagged for 2Swallow are:
None Subjects Flagged

The distribution for subjects and runs in 2Swallow are below. 

![Dice](files/ds003441_task-2Swallow_hist-dicesimilarity.png)
![Voxels Out](files/ds003441_task-2Swallow_hist-voxoutmask.png)
...
#### ses-01
![handvface ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-handvface_map.png)

### handvswallow

#### ses-01
![handvswallow ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-handvswallow_map.png)

### facevswallow

#### ses-01
![facevswallow ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-facevswallow_map.png)

### hand

#### ses-01
![hand ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-hand_map.png)

### face

#### ses-01
![face ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-face_map.png)

### swallow

#### ses-01
![swallow ses-01 Map](files/ds003441_task-2Swallow_ses-01_contrast-swallow_map.png)
