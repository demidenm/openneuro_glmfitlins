# ds003441: 4HandB Task Analysis Report

The size of the Fitlins Derivatives for ds003441 4HandB is 129M with 194 files.
...
- **handvchangehandposition**: 1*`trial_type.Hand` - 1*`trial_type.ChangeHandPosition`
...
## 4.1 Design Matrix
![Design Matrix](./files/ds003441_task-4HandB_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds003441_task-4HandB_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds003441_task-4HandB_vif-boxplot.png)
...
![R Square](files/ds003441_task-4HandB_rsquare-mean.png)
...
The subjects flagged for 4HandB are:
None Subjects Flagged

The distribution for subjects and runs in 4HandB are below. 

![Dice](files/ds003441_task-4HandB_hist-dicesimilarity.png)
![Voxels Out](files/ds003441_task-4HandB_hist-voxoutmask.png)
...
#### ses-01
![handvface ses-01 Map](files/ds003441_task-4HandB_ses-01_contrast-handvface_map.png)

### handvtouchingshoulder

#### ses-01
![handvtouchingshoulder ses-01 Map](files/ds003441_task-4HandB_ses-01_contrast-handvtouchingshoulder_map.png)

### handvchangehandposition

#### ses-01
![handvchangehandposition ses-01 Map](files/ds003441_task-4HandB_ses-01_contrast-handvchangehandposition_map.png)

### facevtouchingshoulder

#### ses-01
![facevtouchingshoulder ses-01 Map](files/ds003441_task-4HandB_ses-01_contrast-facevtouchingshoulder_map.png)
