# ds003481: sae Task Analysis Report

The size of the Fitlins Derivatives for ds003481 sae is 1.9G with 1466 files.
...
trial_type.Alegría, trial_type.Enojo, trial_type.SinRostro, trial_type.Tristeza, intercept

### 2.3 Convolved Regressors
trial_type.Alegría, trial_type.Enojo, trial_type.SinRostro, trial_type.Tristeza
...
- **emotionsvneutral**: 0.33*`trial_type.Enojo` + 0.33*`trial_type.Alegría` + 0.33*`trial_type.Tristeza` - 1*`trial_type.SinRostro`
...
![R Square](files/ds003481_task-sae_rsquare-mean.png)
...
The subjects flagged for sae are:
sub-025_run-02, sub-025_run-03, sub-027_run-03, sub-028_run-02, sub-028_run-03, sub-030_run-01, sub-030_run-02, sub-030_run-03, sub-033_run-02, sub-036_run-03, sub-038_run-01, sub-038_run-02, sub-038_run-03, sub-039_run-01, sub-039_run-02, sub-039_run-03, sub-040_run-03, sub-043_run-01, sub-045_run-03, sub-046_run-01, sub-046_run-02, sub-046_run-03

The distribution for subjects and runs in sae are below. 

![Dice](files/ds003481_task-sae_hist-dicesimilarity.png)
![Voxels Out](files/ds003481_task-sae_hist-voxoutmask.png)

## 5 Statistical Maps

### emotionsvneutral
![emotionsvneutral Map](files/ds003481_task-sae_contrast-emotionsvneutral_map.png)

### positivevnegative
![positivevnegative Map](files/ds003481_task-sae_contrast-positivevnegative_map.png)
