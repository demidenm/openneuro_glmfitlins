# ds003481: sar Task Analysis Report

The size of the Fitlins Derivatives for ds003481 sar is 4.0G with 2762 files.
...
trial_type.ah, trial_type.controlno, trial_type.controlyes, intercept

### 2.3 Convolved Regressors
trial_type.ah, trial_type.controlno, trial_type.controlyes
...
- **speechactsvcontrols**: 1*`trial_type.ah` - 0.5*`trial_type.controlyes` - 0.5*`trial_type.controlno`

- **speechactsvcontrolyes**: 1*`trial_type.ah` - 1*`trial_type.controlyes`

- **speechactsvcontrolno**: 1*`trial_type.ah` - 1*`trial_type.controlno`

- **controlyesvno**: 1*`trial_type.controlyes` - 1*`trial_type.controlno`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds003481_task-sar_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds003481_task-sar_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds003481_task-sar_vif-boxplot.png)
...
![R Square](files/ds003481_task-sar_rsquare-mean.png)
...
![Dice](files/ds003481_task-sar_hist-dicesimilarity.png)
![Voxels Out](files/ds003481_task-sar_hist-voxoutmask.png)

## 5 Statistical Maps

### speechactsvcontrols
![speechactsvcontrols Map](files/ds003481_task-sar_contrast-speechactsvcontrols_map.png)

### speechactsvcontrolyes
![speechactsvcontrolyes Map](files/ds003481_task-sar_contrast-speechactsvcontrolyes_map.png)

### speechactsvcontrolno
![speechactsvcontrolno Map](files/ds003481_task-sar_contrast-speechactsvcontrolno_map.png)

### controlyesvno
![controlyesvno Map](files/ds003481_task-sar_contrast-controlyesvno_map.png)
