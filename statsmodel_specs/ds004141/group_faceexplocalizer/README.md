# ds004141: faceexplocalizer Task Analysis Report

The size of the Fitlins Derivatives for ds004141 faceexplocalizer is 146M with 128 files.
...
trial_type.Alternate, trial_type.Happy, trial_type.Movement, trial_type.Neutral, trial_type.Sad, intercept

### 2.3 Convolved Regressors
trial_type.Alternate, trial_type.Happy, trial_type.Movement, trial_type.Neutral, trial_type.Sad
...
- **facesvcontrol**: 0.3333*`trial_type.Alternate` + 0.3333*`trial_type.Sad` + 0.3333*`trial_type.Happy` - 0.5*`trial_type.Neutral` - 0.5*`trial_type.Movement`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds004141_task-faceexplocalizer_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds004141_task-faceexplocalizer_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds004141_task-faceexplocalizer_vif-boxplot.png)
...
![R Square](files/ds004141_task-faceexplocalizer_rsquare-mean.png)
...
The subjects flagged for faceexplocalizer are:
sub-01_ses-01_run-01, sub-02_ses-01_run-01, sub-10_ses-01_run-01

The distribution for subjects and runs in faceexplocalizer are below. 

![Dice](files/ds004141_task-faceexplocalizer_hist-dicesimilarity.png)
![Voxels Out](files/ds004141_task-faceexplocalizer_hist-voxoutmask.png)
...
#### ses-01
![facesvcontrol ses-01 Map](files/ds004141_task-faceexplocalizer_ses-01_contrast-facesvcontrol_map.png)
