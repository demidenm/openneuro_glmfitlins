# ds004141: nofeedback Task Analysis Report

The size of the Fitlins Derivatives for ds004141 nofeedback is 147M with 128 files.
...
## 4.1 Design Matrix
![Design Matrix](./files/ds004141_task-nofeedback_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds004141_task-nofeedback_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds004141_task-nofeedback_vif-boxplot.png)
...
![R Square](files/ds004141_task-nofeedback_rsquare-mean.png)
...
The subjects flagged for nofeedback are:
sub-02_ses-01_run-01, sub-10_ses-01_run-01

The distribution for subjects and runs in nofeedback are below. 

![Dice](files/ds004141_task-nofeedback_hist-dicesimilarity.png)
![Voxels Out](files/ds004141_task-nofeedback_hist-voxoutmask.png)
...
#### ses-01
![upregfacesvdownregneut ses-01 Map](files/ds004141_task-nofeedback_ses-01_contrast-upregfacesvdownregneut_map.png)
