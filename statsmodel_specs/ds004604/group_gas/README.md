# ds004604: gas Task Analysis Report

The size of the Fitlins Derivatives for ds004604 gas is 670M with 608 files.

Dataset- and task-relevant citations may be found in the papers: [Paper 1](https://www.nature.com/articles/s41598-024-57572-3).
...
- **gas**: 1*`trial_type.gas`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds004604_task-gas_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds004604_task-gas_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds004604_task-gas_vif-boxplot.png)
...
![R Square](files/ds004604_task-gas_rsquare-mean.png)
...
The subjects flagged for gas are:
sub-007, sub-014, sub-026, sub-034, sub-042

The distribution for subjects and runs in gas are below. 

![Dice](files/ds004604_task-gas_hist-dicesimilarity.png)
![Voxels Out](files/ds004604_task-gas_hist-voxoutmask.png)

## 5 Statistical Maps

### gas
![gas Map](files/ds004604_task-gas_contrast-gas_map.png)
