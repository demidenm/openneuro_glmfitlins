# ds004656: FoodStimHiLo Task Analysis Report

The size of the Fitlins Derivatives for ds004656 FoodStimHiLo is 3.0G with 2018 files.

Dataset- and task-relevant citations may be found in the papers: [Paper 1](https://doi.org/10.1007/s11682-015-9366-8).
...
trial_type.cont, trial_type.hi, trial_type.low, intercept

### 2.3 Convolved Regressors
trial_type.cont, trial_type.hi, trial_type.low
...
- **highvlow**: 1*`trial_type.hi` - 1*`trial_type.low`

- **highvcont**: 1*`trial_type.hi` - 1*`trial_type.cont`

- **lowvcont**: 1*`trial_type.low` - 1*`trial_type.cont`


# 4 Figures

## 4.1 Design Matrix
![Design Matrix](./files/ds004656_task-FoodStimHiLo_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds004656_task-FoodStimHiLo_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds004656_task-FoodStimHiLo_vif-boxplot.png)
...
![R Square](files/ds004656_task-FoodStimHiLo_rsquare-mean.png)
...
The subjects flagged for FoodStimHiLo are:
None Subjects Flagged

The distribution for subjects and runs in FoodStimHiLo are below. 

![Dice](files/ds004656_task-FoodStimHiLo_hist-dicesimilarity.png)
![Voxels Out](files/ds004656_task-FoodStimHiLo_hist-voxoutmask.png)
...
#### ses-PM
![highvlow ses-PM Map](files/ds004656_task-FoodStimHiLo_ses-PM_contrast-highvlow_map.png)

#### ses-AM
![highvlow ses-AM Map](files/ds004656_task-FoodStimHiLo_ses-AM_contrast-highvlow_map.png)

### highvcont

#### ses-PM
![highvcont ses-PM Map](files/ds004656_task-FoodStimHiLo_ses-PM_contrast-highvcont_map.png)

#### ses-AM
![highvcont ses-AM Map](files/ds004656_task-FoodStimHiLo_ses-AM_contrast-highvcont_map.png)

### lowvcont

#### ses-PM
![lowvcont ses-PM Map](files/ds004656_task-FoodStimHiLo_ses-PM_contrast-lowvcont_map.png)

#### ses-AM
![lowvcont ses-AM Map](files/ds004656_task-FoodStimHiLo_ses-AM_contrast-lowvcont_map.png)
