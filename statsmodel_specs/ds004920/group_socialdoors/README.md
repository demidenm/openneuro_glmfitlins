...
## 4.1 Design Matrix
![Design Matrix](./files/ds004920_task-socialdoors_design-matrix.svg)

The example design matrix illustrates the model used in the statistical analyses for this task (Note: if motion outliers are included, the number of these will vary between subjects). Each column represents a regressor (of interest or not of interest, based on the above), and each row represents a time point in the BOLD timeseries. The colored patterns show how different experimental conditions are modeled across the scan duration (HRF model).

## 4.2 Contrast Weights
![Contrast Weight](./files/ds004920_task-socialdoors_contrast-matrix.svg)

The contrast maps represent the weights used to model brain activity.

## 4.3 Variance Inflation Factor (VIF)
![VIF Distribution](./files/ds004920_task-socialdoors_vif-boxplot.png)
...
![R Square](files/ds004920_task-socialdoors_rsquare-mean.png)
...
The subjects flagged for socialdoors are:
None Subjects Flagged

The distribution for subjects and runs in socialdoors are below. 

![Dice](files/ds004920_task-socialdoors_hist-dicesimilarity.png)
![Voxels Out](files/ds004920_task-socialdoors_hist-voxoutmask.png)

## 5 Statistical Maps

### decision
![decision Map](files/ds004920_task-socialdoors_contrast-decision_map.png)

### winvloss
![winvloss Map](files/ds004920_task-socialdoors_contrast-winvloss_map.png)
